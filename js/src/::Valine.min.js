    ...
    default, {
        ...
        default,
            ...
            sdkLoader: function(e, t, n) {
                t in window ? (A && clearTimeout(A), n && n()) : l.
    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r) {
            if (n = g(n), "href" === t || "src" === t) {
                ...
                if (M.lastIndex = 0, M.test(n) && (C.lastIndex = 0, C.test(n))) return ""; ! 1 !== r && (r = r || A, n = r.process(n))
            }
            return n = v(n)
        }
        function u(e) {
...
*/
    ...
    function(e, t, n) {
        ...
        o.prototype.init = function(e) {
            var t = this;
            return e = A.
        default.extend(y.DEFAULT_CONFIG, e),
            A.
        default.sdkLoader("https://cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js", "AV",
            function(n) {
                if (t.i18n = (0, g.
            default)(e.lang || A.
            default.lang, e.langMode), t.config = e, "undefined" == typeof document) throw new Error("Sorry, Valine does not support Server-side rendering."); !! e && t._init()
            }),
            t
        },
        o.prototype._init = function() {
            ...
            try {
                ...
                E.params = "?d=" + (d.indexOf(n) > -1 ? n: "mp") + "&v=1.4.4" + p,
                E.hide = "hide" === n,
            ...
            default)(".valine-comment-count"),
                ...
                function t(n) {
                    ...
                    if (r) {
                        var o = (0, A.
                    default)(r).attr("data-xid"); !! o && e.Q(o).count().then(function(e) {
                            r.innerText = e,
                            t(n)
                        }).
                        catch(function(e) {
            ...
            default)(w),
                ...
                e.config.meta = (e.config.guest_info || e.config.meta || $).filter(function(e) {
                    return $.indexOf(e) > -1
                });
        ...
        default.data,
            ...
            e.$preview = {
                show: function() {
                    return O ? (e.$emoji.hide(), o.addClass("actived"), n.html(O).show(), C()) : e.$preview.hide(),
                    e.$preview
                },
                hide: function() {
            ...
            default.detect(i), a = '<span class="vsys">' + i.browser + " " + i.version + '</span> <span class="vsys">' + i.os + " " + i.osVersion + "</span>"),
                ...
                u = E.hide ? "": '<img class="vimg" src="' + (E.cdn + (0, s.
            default)(t.get("mail")) + E.params) + '">',
                d = u + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, w.
            default)(t.get("insertedAt"), e.i18n) + '</span><span class="vat" data-root-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, k.
            ...
            C = function() {
                setTimeout(function() {
                    try {
                        ...
                        "renderMathInElement" in window && renderMathInElement((0, A.
                    default)(".v")[0], {
                            delimiters: [{
                                left: "$$",
                                right: "$$",
            ...
            default.store.set("vlx", Date.now()),
                ...
                if (S.url = decodeURI(e.config.path), S.insertedAt = new Date, T.rid) {
                    ...
                    n.set("rid", T.rid),
                    n.set("pid", r),
                    S.comment = O.replace("<p>", '<p><a class="at" href="#' + r + '">' + T.at + "</a> , ")
                }
                ...
                default.store.set("ValineCache", {
                    ...
                    try {
                        T.rid ? j(t, (0, A.
                    default)('.vquote[data-self-id="' + T.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), j(t, e.$el.find(".vcards")), x.skip++),
        ...
        default)(document).on("keydown",
            function(e) {
                e = event || e;
                var t = e.keyCode || e.which || e.charCode; ((e.ctrlKey || e.metaKey) && 13 === t && z(), 9 === t) && ("veditor" == (document.activeElement.id || "") && (e.preventDefault(), b(i[0], "    ")))
            }).on("paste",
            function(e) {
            ...
            U = function t(n, r) {
                ...
                if (o > 0) {
                    ...
                    b(i[0], s),
                    B(a,
                    function(l, c) { ! l && c ? (i.val(i.val().replace(s, "![" + a.name + "](" + c.data.url + ")\r\n")), (0, d.
                    default)(i[0]), ++r < o ? t(n, r) : M.removeAttr("disabled")) : l && (i.val(i.val().replace(s, "")), (0, d.
                    default)(i[0]), e.$el.find(".status-bar").text(l).empty(3e3))
                    })
                }
            },
            B = function(e, t) {
    ...
    default = function(e) {
        ...
        default)(e, {
                ...
                onIgnoreTagAttr: function(e, t, n, r) {
                    return "class" === t ? t + '="' + o.
                default.escapeAttrValue(n) + '"': "style" === t ? t + '="' + n.replace(/^.*color\:([\d.]+);.*$/, "$1") + '"': "input" === e && "type" === t && "checkbox" === n ? '"' + t + '"="' + o.
            ...
            function(t) {
                ...
                function h(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        ...
                        for (; c < o.length; c++) !
                        function(e) {
                            "code" !== e.type ? --i || u() : l(e.text, e.lang,
                            function(t, n) {
                ...
                n.prototype.token = function(e, t) {
                    ...
                    this.tokens.push({
                        ...
                        this.options.smartLists && c !== d - 1 && (a = g.bullet.exec(o[c + 1])[0], i === a || i.length > 1 && a.length > 1 || (e = o.slice(c + 1).join("\n") + e, c = d - 1)),
                        r = n || /\n\n(?!\s*$)/.test(s),
                        c !== d - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)),
                        h = /^\[[ xX]\] /.test(s),
                        v = void 0,
                        h && (v = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")),
                        this.tokens.push({
    ...
    function(e, t, n) {
        ...
        default.store.get("VsVersion");
            ...
            default.navi,
                ...
                c = i.screen,
                u = ["cc=1", "ck=" + (n.cookieEnabled ? 1 : 0), "cl=" + (c.colorDepth || 0) + "-bit", "ds=" + (c.width || 0) + "x" + (c.height || 0), "vl=" + (s + l), "et=0", "ja=" + (n.javaEnabled() ? 1 : 0), "ln=" + String(o.
            default.lang).toLowerCase(), "lo=1", "lt=" + Math.round( + new Date / 1e3), "rnd=" + Math.round(2147483647 * Math.random()), "si=" + r, "su=https://valine.js.org?v=" + e, "wd=", "v=1.2.72", "lv=1", "sn=" + Math.round( + new Date / 1e3) % 65535, "ct=" + decodeURIComponent(o.
            default.store.get("Hm_cv_" + r) || ""), "tt=" + (a.title || ""), "u=" + i.location.href],
                d = u.join("&"); (new Image).src = "//hm.baidu.com/hm.gif?" + d
            }
        };
        t.
    default = i
    ...
    function(e, t, n) {
        ...
        if (!Object.keys) {
            ...
            r = function(e) {
                ...
                else for (var v in e) p && "prototype" === v || !o.call(e, v) || d.push(String(v));
